...
bootyfit = Event.new(name: "Bootyfit", category: "HIIT", date: Date.today + 1.day, time: Time.now, duration: 60, description: "Targeting abs, thighs and booty, but a full body workout, be prepared to sweat in this intense workout. We will go through different series of exercises each time, using different equipment to challenge your stamina, balance and to get that booty into shape!",
...
boxing = Event.new(name: "Boxing", category: "Boxing", date: Date.today + 1.day, time: Time.now, duration: 60, description: "A high intensity, high cardio class with a focus on English boxing technique.",
...
surf1 = Event.new(name: "Surfing Level 1", category: "Surfing", date: Date.today + 1.day, time: Time.now, duration: 120, description: "It’s now time to jump in the water! During our 2-hour surf lesson, the surf instructor will be right next to you at all times. This way you will always feel safe. Staying in the right spot will guarantee maximum fun. You will also catch as many waves as possible, often from your very first lesson.",
...
muaythai = Event.new(name: "Muay Thai", category: "Boxing", date: Date.today + 1.day, time: Time.now, duration: 90, description: "A 90-minute Muay Thai and kickboxing pad work class, each member gets 3+ rounds of pad work time with one of the trainers, followed by drills, bag work and conditioning.",
...
crossfit = Event.new(name: "Crossfit", category: "Crossfit", date: Date.today + 1.day, time: Time.now, duration: 75, description: "Whether you’re an expert surfer or just getting your feet wet in the surf, yoga is one of the best ways to keep your body loose and agile for the waves. This Yoga For Surfers sequence will take you through 21 yoga poses that focus on lengthening and releasing pressure in the spine, stretching all those surfing muscles, and opening the chest, shoulders, and hips.",
...
surfb = Event.new(name: "Surfing K1", category: "Surfing", date: Date.today + 1.day, time: Time.now, duration: 120, description: "Our beginners surfing lessons are suitable for anyone who has; never surfed before, has very little experience with surfing or it’s been a long time since you last surfed.",
...
surfi = Event.new(name: "Surfing K2", category: "Surfing", date: Date.today + 1.day, time: Time.now, duration: 120, description: "As an intermediate surfer, this wave gives you an opportunity to challenge yourself and to improve your surfing skills dramatically.",
